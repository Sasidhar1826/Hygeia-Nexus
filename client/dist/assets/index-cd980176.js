import{r as d}from"./vendor-3ba6fd3e.js";let I={data:""},O=t=>typeof window=="object"?((t?t.querySelector("#_goober"):window._goober)||Object.assign((t||document.head).appendChild(document.createElement("style")),{innerHTML:" ",id:"_goober"})).firstChild:t||I,C=/(?:([\u0080-\uFFFF\w-%@]+) *:? *([^{;]+?);|([^;}{]*?) *{)|(}\s*)/g,D=/\/\*[^]*?\*\/|  +/g,A=/\n+/g,g=(t,e)=>{let a="",o="",i="";for(let r in t){let s=t[r];r[0]=="@"?r[1]=="i"?a=r+" "+s+";":o+=r[1]=="f"?g(s,r):r+"{"+g(s,r[1]=="k"?"":e)+"}":typeof s=="object"?o+=g(s,e?e.replace(/([^,])+/g,n=>r.replace(/([^,]*:\S+\([^)]*\))|([^,])+/g,l=>/&/.test(l)?l.replace(/&/g,n):n?n+" "+l:l)):r):s!=null&&(r=/^--/.test(r)?r:r.replace(/[A-Z]/g,"-$&").toLowerCase(),i+=g.p?g.p(r,s):r+":"+s+";")}return a+(e&&i?e+"{"+i+"}":i)+o},u={},z=t=>{if(typeof t=="object"){let e="";for(let a in t)e+=a+z(t[a]);return e}return t},S=(t,e,a,o,i)=>{let r=z(t),s=u[r]||(u[r]=(l=>{let c=0,p=11;for(;c<l.length;)p=101*p+l.charCodeAt(c++)>>>0;return"go"+p})(r));if(!u[s]){let l=r!==t?t:(c=>{let p,b,h=[{}];for(;p=C.exec(c.replace(D,""));)p[4]?h.shift():p[3]?(b=p[3].replace(A," ").trim(),h.unshift(h[0][b]=h[0][b]||{})):h[0][p[1]]=p[2].replace(A," ").trim();return h[0]})(t);u[s]=g(i?{["@keyframes "+s]:l}:l,a?"":"."+s)}let n=a&&u.g?u.g:null;return a&&(u.g=u[s]),((l,c,p,b)=>{b?c.data=c.data.replace(b,l):c.data.indexOf(l)===-1&&(c.data=p?l+c.data:c.data+l)})(u[s],e,o,n),s},_=(t,e,a)=>t.reduce((o,i,r)=>{let s=e[r];if(s&&s.call){let n=s(a),l=n&&n.props&&n.props.className||/^go/.test(n)&&n;s=l?"."+l:n&&typeof n=="object"?n.props?"":g(n,""):n===!1?"":n}return o+i+(s??"")},"");function v(t){let e=this||{},a=t.call?t(e.p):t;return S(a.unshift?a.raw?_(a,[].slice.call(arguments,1),e.p):a.reduce((o,i)=>Object.assign(o,i&&i.call?i(e.p):i),{}):a,O(e.target),e.g,e.o,e.k)}let F,$,E;v.bind({g:1});let f=v.bind({k:1});function M(t,e,a,o){g.p=e,F=t,$=a,E=o}function y(t,e){let a=this||{};return function(){let o=arguments;function i(r,s){let n=Object.assign({},r),l=n.className||i.className;a.p=Object.assign({theme:$&&$()},n),a.o=/ *go\d+/.test(l),n.className=v.apply(a,o)+(l?" "+l:""),e&&(n.ref=s);let c=t;return t[0]&&(c=n.as||t,delete n.as),E&&c[0]&&E(n),F(c,n)}return e?e(i):i}}var P=t=>typeof t=="function",k=(t,e)=>P(t)?t(e):t,T=(()=>{let t=0;return()=>(++t).toString()})(),L=(()=>{let t;return()=>{if(t===void 0&&typeof window<"u"){let e=matchMedia("(prefers-reduced-motion: reduce)");t=!e||e.matches}return t}})(),q=20,N=(t,e)=>{switch(e.type){case 0:return{...t,toasts:[e.toast,...t.toasts].slice(0,q)};case 1:return{...t,toasts:t.toasts.map(r=>r.id===e.toast.id?{...r,...e.toast}:r)};case 2:let{toast:a}=e;return N(t,{type:t.toasts.find(r=>r.id===a.id)?1:0,toast:a});case 3:let{toastId:o}=e;return{...t,toasts:t.toasts.map(r=>r.id===o||o===void 0?{...r,dismissed:!0,visible:!1}:r)};case 4:return e.toastId===void 0?{...t,toasts:[]}:{...t,toasts:t.toasts.filter(r=>r.id!==e.toastId)};case 5:return{...t,pausedAt:e.time};case 6:let i=e.time-(t.pausedAt||0);return{...t,pausedAt:void 0,toasts:t.toasts.map(r=>({...r,pauseDuration:r.pauseDuration+i}))}}},H=[],w={toasts:[],pausedAt:void 0},j=t=>{w=N(w,t),H.forEach(e=>{e(w)})},J=(t,e="blank",a)=>({createdAt:Date.now(),visible:!0,dismissed:!1,type:e,ariaProps:{role:"status","aria-live":"polite"},message:t,pauseDuration:0,...a,id:(a==null?void 0:a.id)||T()}),x=t=>(e,a)=>{let o=J(e,t,a);return j({type:2,toast:o}),o.id},m=(t,e)=>x("blank")(t,e);m.error=x("error");m.success=x("success");m.loading=x("loading");m.custom=x("custom");m.dismiss=t=>{j({type:3,toastId:t})};m.remove=t=>j({type:4,toastId:t});m.promise=(t,e,a)=>{let o=m.loading(e.loading,{...a,...a==null?void 0:a.loading});return typeof t=="function"&&(t=t()),t.then(i=>{let r=e.success?k(e.success,i):void 0;return r?m.success(r,{id:o,...a,...a==null?void 0:a.success}):m.dismiss(o),i}).catch(i=>{let r=e.error?k(e.error,i):void 0;r?m.error(r,{id:o,...a,...a==null?void 0:a.error}):m.dismiss(o)}),t};var U=f`
from {
...
`;export{m as c};
//# sourceMappingURL=index-cd980176.js.map
